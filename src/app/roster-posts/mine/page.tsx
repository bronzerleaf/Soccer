            ...
            return (
              ...
              >
                ...
                <div className="mt-3 flex gap-2">
                  {!isExpired ? (
                    <form action={expireRosterPost.bind(null, post.id)}>
                      <button
                        type="submit"
                  ...
                  <form action={deleteRosterPost.bind(null, post.id)}>
                    <button
                      type="submit"
                      className="rounded-md border border-slate-300 px-3 py-1.5 text-sm font-medium text-red-600 hover:border-red-300"
                    >
                      Delete
                    </button>
                  </form>
