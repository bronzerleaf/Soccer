  ...
  return (
    <main className="mx-auto max-w-lg px-6 py-12">
      <AppHeader
        ...
        backHref="/players"
        backLabel="Back to your players"
      />
      ...
      {player.bio ? (
        <div className="mt-4 rounded-[18px] border border-gray-200 bg-white p-4 shadow-[0_3px_16px_rgba(17,24,39,0.07)]">
          ...
          <p className="mt-1.5 text-sm italic leading-6 text-gray-700">{player.bio}</p>
      ...
      {player.team_id && !player.team_membership_verified ? (
        <div className="mt-6 rounded-lg border border-gray-200 bg-amber-50 p-5">
          <p className="text-sm font-medium text-gray-900">
      ...
      {player.instagram_url || player.youtube_url ? (
        <div className="mt-8">
          <h2 className="text-sm font-bold text-gray-900">Connect</h2>
          <div className="mt-2.5 grid grid-cols-2 gap-2">
